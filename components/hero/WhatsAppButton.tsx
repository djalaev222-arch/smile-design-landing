...
export default function WhatsAppButton({ className }: { className?: string }) {
  return (
    <motion.a
      ...
      className={`flex items-center gap-3 rounded-full border-2 border-teal-600/40 bg-surface-card px-5 py-3 text-teal-700 shadow-card transition-colors hover:border-teal-600 hover:bg-teal-50 ${className ?? ""}`}
